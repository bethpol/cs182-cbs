...
# adamw optimizer
ignore_fused = False # to ignore the fused version of AdamW if it's available or not
...
# optimizer
optimizer = model.configure_optimizers(weight_decay, learning_rate, (beta1, beta2), device_type, ignore_fused)
if init_from == 'resume':
