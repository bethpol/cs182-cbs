...
use_scheduler = False           # Set to True to enable
warmup_tokens = 10_000_000      # Warmup phase
stable_tokens = 490_000_000     # Stable phase for a 3phase setup. set to 0 for 2-phase i.e. if you don't want a stable phase and want to go to the decay phase directly after warmup
...
if use_scheduler:
    ...
    if init_from == 'resume' and 'scheduler' in checkpoint:
        ...
        print(f"  Current scheduler step: {scheduler.last_epoch}") # last_epoch: Current step count (despite the confusing name)
